This file is the knowledge-learning&practice documentation. Please don't put anything secret&important in this file. 
The file would(or with much possibility) be uploaded to public space (such as GitHub, Zhihu, or somewhere else) for study use.
...
文件夹中的文档，其中出现的资源，如果被允许（没有版权问题，或为我原创），将尽可能给出。
如果有涉及版权问题或知识分享协议限制的资源，我会尽可能给出获取途径。

如果没有单独声明，本文件夹中的所有文档与代码（作者原创）分别遵守CC-BY-NC-4.0协议以及MIT License。请您遵守知识共享协议声明所要求的共识。我致力于实现一个知识平权的世界。

如果你有任何问题，请通过邮箱ContactMeThroughMail@protonmail.com联系我（田耕一）。